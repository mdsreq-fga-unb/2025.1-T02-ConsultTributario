    ...
    <div className='w-full -screen flex flex-col items-center'>
      <div className='flex flex-col gap-6 max-w-6xl px-4 w-full py-12'>
        ...
        <div className='flex flex-col items-center text-center mb-8'>
          <h1 className='text-4xl md:text-5xl font-bold mb-3'>Por que escolher o ConsultTributario?</h1>
          <p className='text-lg md:text-xl max-w-4xl'> 
Descubra como nossa plataforma pode transformar sua prática tributária.          </p>
        </div>
