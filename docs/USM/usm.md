...
![User Story Mapping - ComumEventos](../assets/images/US_Organizador.png) 

![User Story Mapping - ComumEventos](../assets/images/US_participante.png) 

![User Story Mapping - ComumEventos](../assets/images/US_autores.png) 
