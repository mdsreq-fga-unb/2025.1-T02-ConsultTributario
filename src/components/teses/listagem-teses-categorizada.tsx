...
import { ChevronDown, ChevronUp, Plus, Minus, Edit, Search } from 'lucide-react';
...
export const ListagemTeses = ({
  ...
  const tesesFiltradas = useMemo(() => {
    ...
    const termoNormalizado = normalizeText(termoBusca.trim());
    return teses.filter(tese => normalizeText(tese.title).includes(termoNormalizado));
  }, [teses, termoBusca]);
      ...
      {termoBusca.trim() ? ( // Exibição de resultados filtrados sem agrupamento
        <div className='space-y-3'>
          {tesesFiltradas.length === 0 ? (
            ...
            tesesFiltradas.map((tese: IClaim) => (
              <div
                key={tese._id}
                ...
                >
                  <div className='flex items-center gap-2'>
                    ...
                    <Badge variant='secondary' className='bg-blue-100 text-blue-800'>
                      {tese.taxType?.name || 'Sem tipo definido'}
                    </Badge>
                ...
                {tesesExpandidas.includes(tese._id) && (
                  <div
                    ...
                    style={{
                      ...
                      transitionDuration: tesesExpandidas.includes(tese._id) ? '0.4s' : '0.2s',
                    }}
                  >
                    <div
        ...
        // Exibição original agrupada por categoria
