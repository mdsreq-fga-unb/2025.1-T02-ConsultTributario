...
Revisar o que foi entregue e discutir feedback do cliente.

## Pautas da Reunião

| Nº  | Pauta                    |
| --- | ------------------------ |
| 1   | Revisão dos incrementos  |
| 2   | Revisão do feedback dado |

## Atividades Finalizadas

| História                                                         | Título                                                   | DoD |
| ---------------------------------------------------------------- | -------------------------------------------------------- | --- |
| [US‑01](../../features/realizar-diagnostico-tributario/us-01.md) | Consultar dados públicos de uma empresa a partir do CNPJ | ⏳  |
| [US‑14](../../features/realizar-diagnostico-tributario/us-14.md) | Visualizar relatório de teses tributárias aplicáveis     | ✅  |
...
Será feita ainda uma reunião no dia 14/07 para validação final do MVP.
