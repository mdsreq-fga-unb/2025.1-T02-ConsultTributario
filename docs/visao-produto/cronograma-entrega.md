...
| **2** | 06/05 → 19/05 | Estruturação e Prototipação         | Estrutura básica do projeto (Frontend/Backend), protótipo no Excalidraw para guiar o desenvolvimento.                 | Demonstração do protótipo e da estrutura.                        |
| **3** | 20/05 → 02/06 | Autenticação e Gestão de Teses      | <br> **1.** Criar e editar teses: US-03, US-04. <br> **2.** Visualização de Teses: US-07.                                        | Validação do fluxo de autenticação e gerenciamento de teses.     |
...
| **5** | 17/06 → 30/06 | Gestão de Categorias | **1.** Gestão de Categorias: US-06, US-19, US-17. <br>  | Demonstração das funcionalidades de categorias e validação dos refinamentos. |
