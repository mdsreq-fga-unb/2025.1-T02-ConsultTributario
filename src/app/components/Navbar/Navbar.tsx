    ...
    <div className='w-full bg-white shadow-md border-b border-black-200'>
      <nav className='container mx-auto px-4 py-4 flex justify-between items-center'>
        ...
        <div className='hidden md:flex space-x-8 text-black' >
          <Link href="/funcionalidades/" className='text-lg text-black font-medium hover:text-black-600 transition-colors'>
            Funcionalidades
          </Link>
          <Link href="beneficios" className='text-lg text-black font-medium hover:text-black-600 transition-colors'>
            Benefícios
          </Link>
          <Link href="sobre" className='text-lg text-black font-medium hover:text-black-600 transition-colors'>
            Sobre
          </Link>
        </div>
